...
public class WorldChunkMangerMars extends WorldChunkManager 
{
	...
	protected WorldChunkMangerMars()
	{
		this.myBiomeCache = new BiomeCache(this);
		this.myBiomesToSpawnIn = new ArrayList<BiomeGenBase>();
		this.myBiomesToSpawnIn.add(commander_keen.MarsPlains);
		this.myBiomesToSpawnIn.add(commander_keen.MarsHighlands);
		this.myBiomesToSpawnIn.add(commander_keen.MarsDarkSide);
		this.myBiomesToSpawnIn.add(commander_keen.MarsDarkHighlands);
	}
	
	public WorldChunkMangerMars(long seed, WorldType worldtype)
	{
	this();
	// i changed this to my GenLayerTutorial
	GenLayer[] agenlayer = GenLayerMars.makeTheWorld(seed);
	this.myGenBiomes = agenlayer[0];
	this.myBiomeIndexLayer = agenlayer[1];
	}
	
	public WorldChunkMangerMars(World world)
	{
	...
	*/
	...
	if (biome == null)
	{
	return commander_keen.MarsDarkSide;
	}
	...
	*/
	...
	par1ArrayOfBiomeGenBase[i] = commander_keen.MarsDarkSide;
	}
	}
