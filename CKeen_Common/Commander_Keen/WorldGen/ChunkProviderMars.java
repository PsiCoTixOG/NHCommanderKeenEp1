...
public class ChunkProviderMars implements IChunkProvider 
{
	...
	/** Holds Stronghold Generator - NOOB HAUS: We will need at least 3 custom strongholds */
	//private MapGenStronghold strongholdGenerator = new MapGenStronghold();

	/** Holds Village Generator - NOOB HAUS: these will be the lil tent buildings */
						...
						for (int l1 = 0; l1 < 8; ++l1) 
						{
							...
							for (int i2 = 0; i2 < 4; ++i2) 
							{
								...
								for (int k2 = 0; k2 < 4; ++k2) 
								{
									if ((d16 += d15) > 0.0D) 
									{
										par3ArrayOfByte[j2 += short1] = (byte)commander_keen.MarsStone.blockID;//Block.stone.blockID;
									} 
									else 
									{
				...
				for (int l = 0; l < 16; ++l) 
				{
					...
					for (int k1 = 127; k1 >= 0; --k1) 
					{
						...
						else 
						{
							...
							else if (b3 == commander_keen.MarsStone.blockID) 
							{
								if (j1 == -1) 
								{
									if (i1 <= 0) 
									{
										b1 = 0;
										b2 = (byte) commander_keen.MarsDirt.blockID;//was dirt
									} 
