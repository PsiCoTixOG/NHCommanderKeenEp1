...
public class EntityVorticon extends EntityMob
{

	private static final ItemStack defaultHeldItem = new ItemStack(Item.stick, 1);

	 public EntityVorticon(World par1World)
	 {
    ...
    protected void applyEntityAttributes()
    {
	     ...
	     this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setAttribute(NH_Settings.VorticonDmg);
	     this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(NH_Settings.VorticonHealth);
    }
